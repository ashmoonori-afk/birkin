...
- **Session persistence**: All conversations are stored in SQLite (`birkin_state.py`) with full-text search and unique session titles. JSON logs go to `~/.birkin/sessions/`. (Note: rebranded from the upstream Hermes Agent project.)
