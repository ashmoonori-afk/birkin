...
version: 1.1.0
author: Birkin (adapted from obra/superpowers)
license: MIT
metadata:
  birkin:
...
> **For Birkin:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Birkin tools to understand the project:
