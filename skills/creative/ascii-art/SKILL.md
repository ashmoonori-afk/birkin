...
```bash
python3 -m pyfiglet "BIRKIN" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=BIRKIN&font=Slant" | boxes -d stone
```
