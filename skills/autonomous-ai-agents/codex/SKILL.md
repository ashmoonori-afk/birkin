...
metadata:
  birkin:
    ...
    related_skills: [claude-code, birkin-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Birkin terminal. Codex is OpenAI's autonomous coding agent CLI.
