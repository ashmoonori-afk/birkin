---
name: spreadsheets
description: "Create, inspect, extract, compare, validate, preview, convert, or narrowly update XLSX workbooks."
version: 1.0.0
author: birkin
license: MIT
metadata:
...
```json
{"source":{"content_hash":"<sha256>","uri":"/workspace/.birkin/office/artifacts/incoming/source.xlsx"},"projection":"text","max_spans":1000,"max_nodes":1000,"max_text_bytes":100000}
```

Request a semantic preview, not visual proof:

```json
{"artifact":{"content_hash":"<sha256>","uri":"/workspace/.birkin/office/artifacts/incoming/source.xlsx"},"output_format":"structured_preview"}
```

Queue one consequential patch and export for approval:

```json
{"request":"Replace the approved cell value","source":{"content_hash":"<sha256>","uri":"/workspace/.birkin/office/artifacts/incoming/source.xlsx"},"outcome":"Reviewed XLSX","operations":[{"op":"set_cell","sheet":"Summary","cell":"B2","value":"approved"}],"destination":"/workspace/output/reviewed.xlsx","overwrite_approved":false}
```
