...
```json
{"source":{"content_hash":"<sha256>","uri":"/workspace/.birkin/office/artifacts/incoming/source.pptx"}}
```

```json
{"source":{"content_hash":"<sha256>","uri":"/workspace/.birkin/office/artifacts/incoming/source.pptx"},"projection":"text","max_spans":1000,"max_nodes":1000,"max_text_bytes":100000}
```

Request a semantic preview, not visual proof:

```json
{"artifact":{"content_hash":"<sha256>","uri":"/workspace/.birkin/office/artifacts/incoming/source.pptx"},"output_format":"structured_preview"}
```

Queue one consequential patch and export for approval:

```json
{"request":"Replace the approved slide text","source":{"content_hash":"<sha256>","uri":"/workspace/.birkin/office/artifacts/incoming/source.pptx"},"outcome":"Reviewed PPTX","operations":[{"op":"replace_text","old":"draft","new":"approved"}],"destination":"/workspace/output/reviewed.pptx","overwrite_approved":false}
```
