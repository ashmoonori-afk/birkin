#!/usr/bin/env python3
"""Search arXiv and display results in a clean format (standard library only).

Ported from NousResearch/hermes-agent (skills/research/arxiv), MIT licensed.
...
def search(query=None, author=None, category=None, ids=None, max_results=5, sort="relevance"):
    ...
    req = urllib.request.Request(url, headers={'User-Agent': 'birkin/0.1'})
