#!/usr/bin/env python3
"""
SWE Runner with Birkin Trajectory Format

A runner that uses Birkin-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Birkin-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Birkin-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Birkin format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Birkin-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Birkin-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Birkin Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Birkin-Agent's built-in execution environments
    and outputs trajectories in Birkin-Agent format.
    """
    ...
    def _convert_to_birkin_format(
        ...
        """
        Convert internal message format to Birkin trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Birkin trajectory format
        trajectory = self._convert_to_birkin_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Birkin trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Birkin Trajectory Format")
    print("=" * 60)
