...
Data file: $BIRKIN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_BIRKIN_HOME = Path(os.environ.get("BIRKIN_HOME", Path.home() / ".birkin"))
DATA_DIR = _BIRKIN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
