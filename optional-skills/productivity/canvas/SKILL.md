...
4. Name the token (e.g., "Birkin"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.birkin/.env`:
...
```bash
CANVAS="python $BIRKIN_HOME/skills/productivity/canvas/scripts/canvas_api.py"
