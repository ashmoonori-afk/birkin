...
# Minimum context length required to run Birkin.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent Birkin from probing-down to
...
def _get_context_cache_path() -> Path:
    ...
    return get_birkin_home() / "context_length_cache.yaml"
        ...
        with httpx.Client(timeout=3.0) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # Birkin grow conversations past the runtime limit and Ollama
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Birkin sends to providers:
