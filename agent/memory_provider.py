...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - birkin_home (str): The active BIRKIN_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.birkin``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "birkin").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'birkin memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], birkin_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'birkin memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``birkin_home`` is the active BIRKIN_HOME directory path.
