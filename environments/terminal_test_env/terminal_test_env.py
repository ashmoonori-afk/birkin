...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Birkin"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Birkin",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Birkin",
    },
    {
...
class TerminalTestEnv(BirkinAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/birkin-agent/.env.
        """
