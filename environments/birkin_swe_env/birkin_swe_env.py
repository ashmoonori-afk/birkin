"""
BirkinSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser birkin
    run-api
    python environments/birkin_swe_env.py serve \\
...
class BirkinSweEnv(BirkinAgentBaseEnv):
    ...
    name = "birkin-swe"
    env_config_cls = BirkinSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[BirkinSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = BirkinSweEnvConfig(
            ...
            tool_call_parser="birkin",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="birkin-swe",
        )
