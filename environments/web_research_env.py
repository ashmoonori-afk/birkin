...
Inspired by: GroceryMind — production Birkin agent doing live web research
             across German grocery stores (firecrawl + birkin-agent)
"""
...
# Ensure birkin-agent root is on path
...
class WebResearchEnvConfig(BirkinAgentEnvConfig):
...
class WebResearchEnv(BirkinAgentBaseEnv):
    """
