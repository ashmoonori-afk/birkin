...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("birkin")
        class BirkinToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "birkin", "mistral", "llama3_json")
...
from environments.tool_call_parsers.birkin_parser import BirkinToolCallParser  # noqa: E402, F401
