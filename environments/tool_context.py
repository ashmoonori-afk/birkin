...
ALL birkin-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all birkin-agent tools for a specific rollout.
    ...
    def upload_file(self, local_path: str, remote_path: str) -> Dict[str, Any]:
        ...
        if len(b64) <= chunk_size:
            ...
            tmp_b64 = "/tmp/_birkin_upload.b64"
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any birkin-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("BIRKIN_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("BIRKIN_QUIET", None)
            else:
                os.environ["BIRKIN_QUIET"] = _prev_quiet
