...
slug: /
sidebar_position: 0
title: "Birkin Documentation"
description: "AI that works for you, not the other way around. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
hide_table_of_contents: true
---

# Birkin

AI that works for you, not the other way around. The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/MoonGwanghoon/birkin" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Birkin safely |
| 🧭 **[Use MCP with Birkin](/docs/guides/use-mcp-with-birkin)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Birkin](/docs/guides/use-voice-mode-with-birkin)** | Hands-on setup and usage patterns for Birkin voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Birkin' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Birkin |
...
- **200+ model support** — Works with [OpenRouter](https://openrouter.ai), OpenAI, Anthropic, or any OpenAI-compatible endpoint. Zero vendor lock-in
