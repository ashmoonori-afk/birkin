...
Birkin can generate images from text prompts using FAL.ai's **FLUX 2 Pro** model with automatic 2x upscaling via the **Clarity Upscaler** for enhanced quality.
...
When you ask Birkin to generate an image:
...
Simply ask Birkin to create an image:
