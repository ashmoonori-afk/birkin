...
def _socket_safe_tmpdir() -> str:
    ...
    append ``agent-browser-birkin_…`` the resulting socket path exceeds the
...
def _find_agent_browser() -> str:
    ...
    Checks in order: current PATH, Homebrew/common bin dirs, Birkin-managed
    ...
    # Build an extended search PATH including Homebrew and Birkin-managed dirs.
    ...
    birkin_node_bin = str(birkin_home / "node" / "bin")
    if os.path.isdir(birkin_node_bin):
        extra_dirs.append(birkin_node_bin)
...
def _run_browser_command(
    ...
    try:
        ...
        # Ensure PATH includes Birkin-managed Node first, Homebrew versioned
...
def _maybe_start_recording(task_id: str):
    ...
    try:
        ...
        recordings_dir = birkin_home / "browser_recordings"
...
def browser_vision(question: str, annotate: bool = False, task_id: Optional[str] = None) -> str:
    ...
    screenshots_dir = get_birkin_dir("cache/screenshots", "browser_screenshots")
