...
Trust levels:
  - builtin:   Ships with Birkin. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.birkin/\.env|\~/\.birkin/\.env',
     "birkin_env_access", "critical", "exfiltration",
     "directly references Birkin secrets file"),
    ...
    (r'\.birkin/config\.yaml|\.birkin/SOUL\.md',
     "birkin_config_mod", "critical", "persistence",
     "references Birkin configuration files directly"),
