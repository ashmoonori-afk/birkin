# Streaming LLM Response Support for Birkin
...
```
BIRKIN_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("BIRKIN_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `birkin_cli/config.py` | 1 | +streaming config defaults |
