...
| **Self-improvement loop** | Curator system; configurable `curator.interval_hours` (AGENTS.md) | Not detailed | **Morpheus** — daily **07:00** routine with restricted toolset; routes all writes through approvals (`morpheus.py`, ADR-028) |
