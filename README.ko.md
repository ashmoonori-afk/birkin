...
[![OS별 런타임](https://img.shields.io/badge/runtime-platform_scoped-b8f36b?style=flat-square&labelColor=070b12)](./pyproject.toml)
...
| **stdlib 중심 코어** | OS별 음성·데스크톱 의존성만 둔 작은 파이썬 패키지 하나. Node도, Docker도, vector DB도 없습니다. |
...
- **번들 스킬 55개**, **OS별 런타임 의존성**, Python 3.10+.
