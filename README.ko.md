...
hermes 표준과 호환. [`skills/`](./skills) 아래 **50개 번들**(research·software·
writing·data·devops·marketing·planning/**neurosis**·automation/**morpheus** 등)
+ `~/.birkin/skills/`의
...
- 오프라인 **테스트 412개** 통과(API 키 없이), **번들 스킬 50개**, **런타임
  의존성 0**, Python 3.10+.
