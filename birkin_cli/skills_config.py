"""
Skills configuration for Birkin.
`birkin skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.birkin/config.yaml under:
...
from birkin_cli.platforms import PLATFORMS as _PLATFORMS
