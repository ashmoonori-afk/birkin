...
Usage:
    birkin pairing list              # Show all pending + approved users
    birkin pairing approve <platform> <code>  # Approve a pairing code
    birkin pairing revoke <platform> <user_id> # Revoke user access
    birkin pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle birkin pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: birkin pairing {list|approve|revoke|clear-pending}")
        print("Run 'birkin pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'birkin pairing list' to see pending codes.\n")
