...
def _reload_constants():
    """Reload birkin_constants to get a fresh apply_ipv4_preference."""
    import birkin_constants
    importlib.reload(birkin_constants)
    return birkin_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_birkin_ipv4_patched", False) is True
