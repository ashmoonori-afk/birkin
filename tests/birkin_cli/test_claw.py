"""Tests for birkin claw commands."""
...
from birkin_cli import claw as claw_mod
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.birkin/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.birkin/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.birkin/migration/openclaw/20250312T120000",
        }
