"""Tests for the interactive session browser (`birkin sessions browse`).
...
from birkin_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """birkin sessions browse should be parseable."""
        from birkin_cli.main import main as _main_entry
