...
class TestParserRegistry:
    ...
    def test_birkin_parser_registered(self):
        parsers = list_parsers()
        assert "birkin" in parsers
...
class TestBirkinParser:
    @pytest.fixture
    def parser(self):
        return get_parser("birkin")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["birkin"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use birkin format since that's universal
