...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure redaction is active regardless of host BIRKIN_REDACT_SECRETS."""
    monkeypatch.delenv("BIRKIN_REDACT_SECRETS", raising=False)
...
class TestBrowserSecretExfil:
    ...
    def test_allows_normal_url(self):
        ...
        from tools.browser_tool import browser_navigate
        result = browser_navigate("https://github.com/NousResearch/birkin-agent")
        parsed = json.loads(result)
