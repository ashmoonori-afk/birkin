...
class TestWriteDenyExactPaths:
    ...
    def test_birkin_env(self):
        path = os.path.join(str(Path.home()), ".birkin", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_birkin_config_not_env(self):
        path = os.path.join(str(Path.home()), ".birkin", "config.yaml")
