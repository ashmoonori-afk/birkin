...
def test_windows_picker_selects_all_supported_import_paths() -> None:
...
def test_full_window_drop_routes_one_supported_path_to_import() -> None:
    ...
    assert "OfficeFileSelection.IsSupported" in source
