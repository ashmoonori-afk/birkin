...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("birkin_cli.config.get_config_path", return_value=config_path), \
             patch("birkin_cli.config.ensure_birkin_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("birkin_cli.config.get_env_path", return_value=env_path), \
             patch("birkin_cli.config.ensure_birkin_home"):
    ...
    def test_ensure_birkin_home_sets_0700(self):
        home = Path(self.tmpdir) / ".birkin"
        with patch("birkin_cli.config.get_birkin_home", return_value=home):
