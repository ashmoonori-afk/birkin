...
being persisted to ~/.birkin/discord_threads.json.
"""
...
class TestDiscordThreadPersistence:
    ...
    def _make_adapter(self, tmp_path):
        """Build a minimal DiscordAdapter with BIRKIN_HOME pointed at tmp_path."""
    ...
    def test_missing_birkin_home_does_not_crash(self, tmp_path):
        """Load/save tolerate missing directories."""
        fake_home = tmp_path / "nonexistent" / "deep"
        with patch.dict(os.environ, {"BIRKIN_HOME": str(fake_home)}):
