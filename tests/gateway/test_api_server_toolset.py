"""Tests for birkin-api-server toolset and API server tool availability."""
import os
import json
...
class TestBirkinApiServerToolset:
    """Tests for the birkin-api-server toolset definition."""

    def test_toolset_exists(self):
        ts = get_toolset("birkin-api-server")
        assert ts is not None

    def test_toolset_validates(self):
        assert validate_toolset("birkin-api-server")

    def test_toolset_includes_web_tools(self):
        tools = resolve_toolset("birkin-api-server")
...
class TestApiServerPlatformConfig:
    def test_platforms_dict_includes_api_server(self):
        ...
        assert PLATFORMS["api_server"]["default_toolset"] == "birkin-api-server"
...
class TestApiServerAdapterToolset:
    ...
    def test_create_agent_reads_config_toolsets(self):
        ...
        with patch("gateway.run._resolve_runtime_agent_kwargs") as mock_kwargs, \
            ...
            # No platform_toolsets override — should fall back to birkin-api-server default
