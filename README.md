...
[![Platform-scoped runtime](https://img.shields.io/badge/runtime-platform_scoped-b8f36b?style=flat-square&labelColor=070b12)](./pyproject.toml)
...
| **Stdlib-first core** | One small Python package with platform-scoped voice and desktop dependencies. No Node, no Docker, no vector database. |
...
to install — web search adds no dependency because this path uses `urllib` and
...
- **55 bundled skills**, **platform-scoped runtime dependencies**, Python 3.10+.
