...
Birkin requires Python 3.10 or newer. The repository currently identifies as Birkin `0.4.426`. This is the source version, not a claim that the same version is installed on your machine or available as a signed public app.
