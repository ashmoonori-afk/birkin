...
required = {
    "connected", "chat-send-stream", "terminal-create-lease",
...
if not any(name in names for name in ("session-create", "session-select")):
    raise SystemExit("no session step was recorded")
digests = {}
