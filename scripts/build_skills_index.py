#!/usr/bin/env python3
"""Build the Birkin Skills Index — a centralized JSON catalog of all skills.
...
`birkin skills search/install` can use it without hitting the GitHub API.
...
# Ensure BIRKIN_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("BIRKIN_HOME", os.path.join(os.path.expanduser("~"), ".birkin"))
...
def main():
    print("Building Birkin Skills Index...", flush=True)
